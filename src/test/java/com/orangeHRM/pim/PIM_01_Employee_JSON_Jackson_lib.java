...
public class PIM_01_Employee_JSON_Jackson_lib extends BaseTest {
    ...
    private EmployeeDataInfo employeeData;
    ...
    public void beforeClass(String browserName, String url) {
        ...
        employeeData = EmployeeDataInfo.getEmployeeDataInfo();
        username = employeeData.getUsername();
        password = "AnTest@123";
        firstName = employeeData.getFirstName();
        middleName = employeeData.getMiddleName();
        lastName = employeeData.getLastName();
        loginPage = PageGenerator.getLoginPage(driver);
        loginPage.loginToSystem(adminUsername,adminPassword);
        street1 = employeeData.getStreet1();
        street2 = employeeData.getStreet2();
        city = employeeData.getCity();
        stateProvince = employeeData.getStateProvince();
        zipPostalCode = employeeData.getZipPostalCode();
        countryName = employeeData.getCountryName();
        homePhone = employeeData.getHomePhone();
        mobilePhone= employeeData.getMobilePhone();
        workPhone = employeeData.getWorkPhone();
        workEmail = employeeData.getWorkEmail();
        otherEmail = employeeData.getOtherEmail();
        emergencyContactName = employeeData.getEmergencyContactName();
        emergencyContactRelationship = employeeData.getEmergencyContactRelationship();
        emergencyHomePhone = employeeData.getEmergencyContactHomePhone();
        dependentName = employeeData.getDependentName();
